...
const Overview = ({
  ...
  <section className="py-24 px-8 bg-white dark:bg-gray-900 dark:text-white relative transition-colors duration-300">
    <Triangle color="text-white dark:text-gray-900 transition-colors duration-300" />
